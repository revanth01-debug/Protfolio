...
# ------------------------------
# 2️⃣ Capture multiple people's faces
# ------------------------------
...
print("Enter names of people to capture, separated by comma:")
...
for name in people_names:
    ...
    print(f"\nCapturing {num_images} images of {name}...")
...
# ------------------------------
# 4️⃣ Live recognition & attendance
# ------------------------------
cap = cv2.VideoCapture(0)
